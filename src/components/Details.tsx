    ...
    return (
        <div className={ (props.floatingDetails === true) 
                            ? (props.invertedDetails === true) 
                                ? "right-[6px] absolute z-10 mt-[2px] h-0 w-0 group-hover:h-[300px] group-hover:w-[550px] transition-all duration-1000 ease-in-out bg-cover border-0 group-hover:border-2 border-gray-300" 
                                : "left-[6px] absolute z-10 mt-[2px] h-0 w-0 group-hover:h-[300px] group-hover:w-[550px] transition-all duration-1000 ease-in-out bg-cover border-0 group-hover:border-2 border-gray-300"
